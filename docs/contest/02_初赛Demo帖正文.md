...
* **主要功能：**
  ...
  **① AI 对话 + 养老知识库 RAG**
  ...
  ![AI 对话界面 — 用户提问"高龄津贴怎么申请"，AI 检索知识库并生成回答](product_01_ai_chat_rag.png)

  ![对话追问 — 用户继续追问细节，AI 基于上下文给出来源引用](product_02_chat_followup.png)
  ...
  **② 适老化交互设计 — 语音 + 大字号**
  ...
  ![适老化对话界面 — 琥珀主题 + 语音输入按钮 + 朗读按钮 + 大字号](product_03_elderly_voice_tts.png)
  ...
  **③ 紧急安全机制 — 急症检测 + SOS 求助**
  ...
  ![SOS 紧急求助 — 对话界面右下角常驻红色 SOS 按钮，点击弹出紧急求助面板](product_04_sos_emergency.png)

  ![急症关键词检测 — 当老人输入急症相关词汇时，系统自动弹窗提醒并给出应急建议](product_05_emergency_alert.png)

  **④ 养老专属 Skills**
  - **老年人综合评估** — 基于 ADL 日常生活能力、MMSE 认知功能、跌倒风险、营养状况、情绪状态等维度，生成结构化评估报告；
  - **个性化护理计划生成** — 根据老人健康状况，自动生成日常安排、饮食方案、运动方案和用药管理建议。

  ![养老专属 Skill — 老年人综合评估 / 护理计划生成结果](product_06_skill_result.png)

  ![Skill 运行概览 — 技能调用过程与结构化输出](product_07_skill_overview.png)
